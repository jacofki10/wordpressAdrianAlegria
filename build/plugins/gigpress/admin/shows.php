		...
		<form action="" method="post">
			...
			<table class="wp-list-table widefat">
				...
				<tbody>
					...
					if ($shows != FALSE) {
						...
						foreach ($shows as $show) {
							...
							<tr class="<?php echo 'gigpress-' . $showdata['status']; ?>">
								...
								<td><span class="gigpress-date"><?php echo $showdata['date'];
																								if ($showdata['end_date']) {
																									echo (' - ') . $showdata['end_date'];
																								} ?></span>
									<span class="gigpress-date"><?php echo $showdata['date_long'];
																							if ($showdata['end_date_long']) {
																								echo (' - ') . $showdata['end_date_long'];
																							} ?></span>
								</td>
								<td><?php echo $showdata['artist']; ?></td>
								<td><?php echo $showdata['venue']; ?></td>
								<td><?php echo $showdata['city'];
										if (!empty($showdata['state'])) echo ', ' . $showdata['state']; ?></td>
					...
					?>
						<tr>
							<td colspan="8"><?php _e("Sorry, no shows to display based on your criteria.", "gigpress"); ?></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
