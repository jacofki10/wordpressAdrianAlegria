		...
		<form method="post" action="options.php">
			...
			<table class="gp-table form-table">
				...
				<tr>
					<th scope="row"><?php _e("Long date format", "gigpress") ?>:</th>
					<td>
						<input type="text" name="gigpress_settings[date_format_long2]" value="<?php echo $gpo['date_format_long2']; ?>" />
						<span><?php _e("Output", "gigpress") ?>: <strong><?php echo mysql2date($gpo['date_format_long2'], GIGPRESS_NOW); ?></strong></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<p><label><input type="checkbox" name="gigpress_settings[artist_link]" value="1" <?php if (!empty($gpo['artist_link'])) echo ('checked="checked"'); ?> /> <?php _e("Link artist names to their URLs.", "gigpress") ?></label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<p><label><input type="checkbox" name="gigpress_settings[target_blank]" value="1" <?php if (!empty($gpo['target_blank'])) echo ('checked="checked"'); ?> /> <?php _e("Open external links in new windows.", "gigpress") ?></label>
					</td>
				</tr>
				<tr>
